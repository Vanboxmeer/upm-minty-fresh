...
const Pricing = () => {
  ...
  return <section id="coverage-packages" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto items-stretch">
          {plans.map((plan, index) => <Card key={index} className={`relative flex flex-col h-full ${plan.popular ? 'border-primary shadow-lg' : 'border-border'} transition-all hover:shadow-lg`}>
