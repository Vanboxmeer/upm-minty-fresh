...
const Payment = ({ planName, planType }: PaymentProps) => {
  ...
  const getPlanDetails = (type: "gold" | "silver" | "growth" | "scale" | "dominate", isAnnual: boolean): PlanDetails => {
    const plans = {
      gold: {
        monthly: { price: 995, setupFee: 0 },
        annual: { price: 995 * 10, setupFee: 0, savings: 995 * 2 }
      },
      silver: {
        monthly: { price: 250, setupFee: 0 },
        annual: { price: 250 * 10, setupFee: 0, savings: 250 * 2 }
      },
      growth: {
        monthly: { price: 5000, setupFee: 0 }
      },
      scale: {
        monthly: { price: 25000, setupFee: 0 }
      },
      dominate: {
        monthly: { price: 100000, setupFee: 0 }
      }
    };
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            {isPackagePlan 
              ? "Choose your preferred payment method to order your package."
              : "Choose your billing frequency and preferred payment method to get started."
            }
          </p>
        </div>
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-muted-foreground">
            All payments are processed securely. Contact support@upm.com for custom payment arrangements.
          </p>
        </div>
      </div>
    </section>
