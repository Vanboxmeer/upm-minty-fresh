          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="max-w-none space-y-8 text-foreground">
              <section>
                ...
                <p className="text-foreground leading-relaxed">By accessing and using UnitedPress.Media's website and services, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using our services. The words "you" and "your" refer to each customer, website visitor, clients, or application user, "we", "us" and "our" refer to 'UPM' (unitedpress.media) and "Services" and or "Coverages" refers to all services provided by us. UPM (unitedpress.media) is operated by BVB Management Inc – Charles Court, 1st Floor, 189 Main Street, P.O. Box 4406, Tortola VG1110 British Virgin Islands.</p>
              </section>

              <section>
                <h2 className="text-2xl font-semibold mb-4 text-foreground">Description of Services</h2>
                <p className="mb-4 text-foreground leading-relaxed">UPM unitedpress.media is a digital marketing service and media partner registered in the British Virgin Islands (BVI), offering international services such as:</p>
                ...
                <p className="mt-4 text-foreground leading-relaxed">These services may involve coordination with third-party providers, such as content creators and ad platforms, funded through client-provided budgets.</p>
              </section>

              <section>
                <h2 className="text-2xl font-semibold mb-4 text-foreground">User Responsibilities</h2>
                <h3 className="text-xl font-medium mb-3 text-foreground">Content Requirements</h3>
                <p className="mb-4 text-foreground leading-relaxed">You agree to:</p>
                ...
                <h3 className="text-xl font-medium mb-3 mt-6 text-foreground">Account Responsibilities</h3>
                <ul className="list-disc pl-6 space-y-2 text-foreground">
              ...
              <section>
                ...
                <h3 className="text-xl font-medium mb-3 mt-6 text-foreground">Subscription Fees and Service Fees</h3>
                <div className="bg-muted p-6 rounded-lg space-y-3 text-foreground">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-foreground">Cryptocurrency and Digital Asset Payments</h2>
                <p className="mb-4 text-foreground leading-relaxed">Clients may provide campaign budgets via web3 wallets (e.g., transferring USDC or other digital assets to a UPM-controlled wallet). These budgets fund UPM's subscription fees, service fees, and campaign executions such as press release packages, ad buying, and payments to content creators.</p>
                <div className="bg-muted p-6 rounded-lg mb-4 text-foreground">
                ...
                <p className="text-foreground leading-relaxed">Clients acknowledge that cryptocurrency payments involve risks such as volatility, and UPM is not responsible for any losses due to market fluctuations after receipt. All transactions are final upon confirmation on the blockchain or payment processor, and UPM acts as a merchant accepting digital assets as payment for services, in compliance with BVI regulations.</p>
              </section>

              <section>
                <h2 className="text-2xl font-semibold mb-4 text-foreground">VAT Disclaimer</h2>
                <p className="text-foreground leading-relaxed">Prices may be subject to value-added tax (VAT) or other applicable taxes based on your location and tax status. VAT rates and regulations vary by country, and it's the customer's responsibility to ensure compliance with local tax laws. For more information, please contact us or your local tax authority.</p>
              </section>

              <section>
                <h2 className="text-2xl font-semibold mb-4 text-foreground">Withholding Tax and Client Responsibility</h2>
                <p className="text-foreground leading-relaxed">Clients are responsible for ensuring compliance with local tax laws and regulations, including VAT and withholding tax. As a BVI-registered company, we comply with applicable tax laws and regulations in the jurisdictions where we operate.</p>
              </section>

              <section>
                <h2 className="text-2xl font-semibold mb-4 text-foreground">Service Delivery and Performance</h2>
                <h3 className="text-xl font-medium mb-3 text-foreground">Our Commitments</h3>
                ...
                <h3 className="text-xl font-medium mb-3 text-foreground">Limitations</h3>
                <ul className="list-disc pl-6 space-y-2 text-foreground">
              ...
              <section>
                ...
                <h3 className="text-xl font-medium mb-3 text-foreground">Refund Eligibility:</h3>
                ...
                <div className="bg-muted p-6 rounded-lg mb-4 text-foreground">
                  <p className="mb-3">For any refund requests involving campaign budgets funded via web3 wallets or digital assets, applicable subscription fees and service fees (e.g., 3.45% or other plan-specific percentages) will be deducted prior to processing the refund. If a client is on the 'free plan' and a refund is required, it will fall under the 'silver plan' service fees, which will be deducted accordingly.</p>
                  <p>Refunds will be issued in the original form of payment where possible, subject to blockchain transaction fees or conversion costs, which may reduce the refunded amount.</p>
                </div>
                <p className="text-foreground leading-relaxed">To request a refund, contact us within 14 days of service completion with detailed reasons.</p>
              </section>
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-foreground">Force Majeure</h2>
                <p className="mb-4 text-foreground leading-relaxed">Neither party shall be liable for any failure or delay in performing its obligations under these Terms of Service if such failure or delay is caused by events beyond its reasonable control, including but not limited to acts of God, natural disasters, war, terrorism, riots, embargoes, acts of civil or military authorities, fire, floods, accidents, pandemics, strikes, or shortages of transportation facilities, fuel, energy, labor, or materials ("Force Majeure Events").</p>
                <p className="text-foreground leading-relaxed">In the event of a Force Majeure Event, the affected party shall notify the other party promptly and use reasonable efforts to resume performance as soon as possible. If the Force Majeure Event continues for more than 30 days, either party may terminate the services upon written notice, subject to the Termination and Refund Policy provisions.</p>
              </section>

              <section>
                <h2 className="text-2xl font-semibold mb-4 text-foreground">Dispute Resolution</h2>
                <p className="text-foreground leading-relaxed">Any disputes arising from these terms or our services shall be resolved through binding arbitration in accordance with the rules of the ADR Institute of Canada. The arbitration shall take place in Toronto, Ontario, and be conducted in English.</p>
              </section>

              <section>
                <h2 className="text-2xl font-semibold mb-4 text-foreground">Governing Law and Changes</h2>
                <p className="mb-4 text-foreground leading-relaxed">These Terms of Service are governed by the laws of the British Virgin Islands. We reserve the right to modify these Terms of Service at any time without prior notice. Any changes will be effective immediately upon posting.</p>
              </section>
