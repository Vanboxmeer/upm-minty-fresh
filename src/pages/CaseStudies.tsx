...
const CaseStudies = () => {
  const caseStudies = [
    {
      ...
      results: [
        { metric: "Media Coverage", value: "180+ publications", icon: Globe },
        { metric: "Website Traffic", value: "+450% increase", icon: Eye },
        { metric: "Community Growth", value: "25K new followers", icon: Users },
        { metric: "Token Pre-sale", value: "$2.3M raised", icon: TrendingUp }
      ],
      timeline: "6 weeks",
    ...
    },
    {
      ...
      results: [
        { metric: "Total Reach", value: "2.8M impressions", icon: Eye },
        { metric: "Engagement Rate", value: "8.5% average", icon: MessageCircle },
        { metric: "Discord Members", value: "+12K new joins", icon: Users },
        { metric: "NFT Collection", value: "Sold out in 4 hours", icon: TrendingUp }
      ],
      timeline: "4 weeks",
    ...
    },
    {
      ...
      results: [
        { metric: "Tier-1 Features", value: "12 major publications", icon: Globe },
        { metric: "LinkedIn Views", value: "850K profile views", icon: Eye },
        { metric: "Lead Generation", value: "340 qualified leads", icon: Users },
        { metric: "Enterprise Deals", value: "5 contracts signed", icon: TrendingUp }
      ],
      timeline: "8 weeks",
    ...
    },
    {
      ...
      results: [
        { metric: "Viral Posts", value: "15M+ total views", icon: Eye },
        { metric: "Community Growth", value: "75K Telegram members", icon: Users },
        { metric: "Media Mentions", value: "90+ publications", icon: Globe },
        { metric: "Market Cap Peak", value: "$50M achieved", icon: TrendingUp }
      ],
      timeline: "3 weeks",
    ...
    },
    {
      ...
      results: [
        { metric: "App Downloads", value: "150K in first month", icon: TrendingUp },
        { metric: "Media Coverage", value: "250+ publications", icon: Globe },
        { metric: "Social Following", value: "45K across platforms", icon: Users },
        { metric: "User Retention", value: "68% monthly active", icon: MessageCircle }
      ],
      timeline: "12 weeks",
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      case "Press Release": return "bg-blue-500/10 text-blue-400 border-blue-500/20";
      case "Influencer Marketing": return "bg-purple-500/10 text-purple-400 border-purple-500/20";
      case "Media Coverage": return "bg-green-500/10 text-green-400 border-green-500/20";
      case "Integrated Campaign": return "bg-orange-500/10 text-orange-400 border-orange-500/20";
      case "Full Campaign": return "bg-pink-500/10 text-pink-400 border-pink-500/20";
        ...
        <section className="py-16 bg-gradient-to-b from-primary/5 to-background">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Real results from real clients. See how our strategic marketing campaigns have helped crypto projects achieve their goals and exceed expectations.
            </p>
            <div className="flex justify-center gap-4 text-sm text-muted-foreground">
              <span>• Client names anonymized for privacy</span>
              <span>• All metrics verified</span>
              <span>• Results within stated timelines</span>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="grid gap-8 max-w-4xl mx-auto">
              {caseStudies.map((study) => (
                <Card key={study.id} className="p-8 hover:shadow-lg transition-shadow">
                    ...
                    <div>
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        {study.results.map((result, index) => {
                          ...
                          return (
                            <div key={index} className="flex items-center gap-3 p-3 bg-card/50 rounded-lg border">
